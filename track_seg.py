...
from yolov7.utils.downloads import attempt_download
from yolov7.utils.dataloaders import LoadImages, LoadStreams
from yolov7.utils.general import (LOGGER, Profile, check_img_size, check_imshow, cv2,
                           non_max_suppression, scale_coords, xyxy2xywh)
from yolov7.utils.segment.general import process_mask, scale_masks
from yolov7.utils.segment.plots import plot_masks
...
def detect(opt):
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        # Inference
        with dt[1]:
            pred, output = model(im, augment=opt.augment)
            proto = output[1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='./yolov7/weights/yolov7-seg.pt', help='model.pt path')
    parser.add_argument('--deep_sort_weights', type=str, default='./deep_sort_pytorch/deep_sort/deep/checkpoint/ckpt.t7', help='ckpt.t7 path')
    # file/folder, 0 for webcam
    parser.add_argument('--source', type=str, default='0', help='source')
    parser.add_argument('--data', type=str, default='./yolov7/data/coco128.yaml', help='(optional) dataset.yaml path')
